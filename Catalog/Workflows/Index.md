...
Workflow definitions organized by category. This file is the canonical registry — all 22 workflows are listed here with their metadata aligned to the frontmatter of each individual workflow file.
...
| MosaicTest | `Workflows/MosaicTest/` | Harness conformance fixtures for `mosaic-run`; not for productive work |
