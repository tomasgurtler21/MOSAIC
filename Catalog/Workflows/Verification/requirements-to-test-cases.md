...
|---|---|---|
| Test case format specification | `<TestCaseFormatSpecification type="project">` | `test-case-writer`, `test-case-review` |
| Abstraction / controlled vocabulary | `<ControlledVocabulary type="project">` | `test-case-writer`, `test-case-review` |
| Scenario dimension taxonomy | `<CoverageDimensions type="project">` | `test-scenario-designer`, `test-scenario-review` |
