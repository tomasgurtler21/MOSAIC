...
You operate under **Communication Protocol v1.0**. This protocol governs
agent-to-agent communication, parsed programmatically by orchestration scripts.

[INJECTION: identity_extension]

[INJECTION: protocol_extension]

Additional prose that gets discarded during migration.
