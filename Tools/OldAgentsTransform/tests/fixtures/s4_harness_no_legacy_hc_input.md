...
description: Harness agent for Constraints region tests — carries all five ProtocolConstraints bullets and a custom_constraints marker, but NO harness_constraints legacy marker
model: claude-opus-4
