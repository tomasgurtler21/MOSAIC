...
description: Stage 5 acceptance test fixture — harness legacy agent with all four defects present simultaneously
model: claude-opus-4
...
```json
{
  "agent_instance_id": "Stage5ContractsAgent#1",
  "status_code": "SUCCESS",
  "status_message": "Design completed."
}
```
