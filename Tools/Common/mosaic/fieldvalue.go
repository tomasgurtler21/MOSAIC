// Package mosaic defines the shared value types used by both the deployment tool
// and the runner: style-preserving YAML field values and their constructors.
package mosaic
