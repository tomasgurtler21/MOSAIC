...
// Internal tests for parseTaskMessage. This file is in package opencode
// (not opencode_test) because parseTaskMessage is unexported and can only
...
// claudecode/parse_task_message_test.go. Both adapters share the same
