...
| Composition Root | The only place outside `internal/harness/` allowed to construct a concrete adapter (`claudecode.New` or `fake.New`) and wire it behind the port. |
