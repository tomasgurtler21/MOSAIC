...
// TestGHCPCLI_Frontmatter_OrchestratorAgent_DoesNotStampMosaicOrchestratorInjectionsVersion
...
func TestGHCPCLI_Frontmatter_OrchestratorAgent_DoesNotStampMosaicOrchestratorInjectionsVersion(t *testing.T) {
	mod := newModule(t)
...
// TestGHCPCLI_Descriptor_KeyOrder_DoesNotContainMosaicOrchestratorInjectionsVersion verifies
// that the ghcp-cli descriptor's key_order list does NOT contain
...
func TestGHCPCLI_Descriptor_KeyOrder_DoesNotContainMosaicOrchestratorInjectionsVersion(t *testing.T) {
	mod := newModule(t)
	desc := mod.Descriptor()
