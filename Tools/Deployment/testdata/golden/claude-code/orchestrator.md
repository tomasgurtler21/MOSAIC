...
- `Task` tool description has a lot of additional/duplicate fields to MOSAIC communication protocol. Fill only message according to communication protocol, and do not fill any additional fields. Subagents will ignore them anyway. MOSAIC communicattion protocol always takes precedence.[[/INJECTION:HarnessConstraints]]
