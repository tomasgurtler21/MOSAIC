...
Workflow definitions organized by category. This file is the canonical registry — all 15 workflows are listed here with their metadata aligned to the frontmatter of each individual workflow file.

## How to Use Workflows

### Finding a Workflow

Workflows are organized into five categories reflecting their primary purpose:
