...
- Naming: kebab-case files, PascalCase classes/interfaces, camelCase functions/variables, UPPER_SNAKE_CASE constants
...
- **Error handling:** Custom `AppError` with HTTP codes, centralized error middleware, never swallow errors
