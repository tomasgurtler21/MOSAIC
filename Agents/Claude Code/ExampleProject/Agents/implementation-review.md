...
- **Validation:** All API inputs validated with Zod schemas in `src/models/`
- **Errors:** Custom `AppError` class with HTTP status codes; centralized error middleware in `src/middleware/`
