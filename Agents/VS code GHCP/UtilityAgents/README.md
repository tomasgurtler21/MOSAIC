...
This directory contains three utility agents for creating and maintaining the multi-agent orchestration system:
...
- Injection points and platform-specific adaptations require judgment that only you can provide
