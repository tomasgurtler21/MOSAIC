...
tools: ['read/readFile', 'read/problems', 'read/terminalLastCommand', 'edit/editFiles', 'edit/createFile', 'edit/createDirectory', 'search/fileSearch', 'search/textSearch', 'search/listDirectory', 'search/codebase', 'search/usages', 'search/changes', 'execute/runInTerminal', 'execute/testFailure', 'execute/getTerminalOutput', 'web/fetch', 'vscode/askQuestions', 'vscode/runCommand', 'todo', 'agent']
