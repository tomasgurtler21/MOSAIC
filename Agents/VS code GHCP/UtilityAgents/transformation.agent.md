...
name: transformation
tools: ['read/readFile', 'edit/editFiles', 'edit/createFile', 'search/fileSearch', 'search/textSearch', 'search/listDirectory', 'web/fetch', 'agent', 'vscode/askQuestions', 'execute/runInTerminal']
