...
tools: ['read/readFile', 'edit/editFiles', 'edit/createFile', 'search/fileSearch', 'search/textSearch', 'search/listDirectory', 'vscode/askQuestions']
...
- **Communication Protocol v1.6:** Standardized JSON messages between orchestrator and subagents
...
Include all relevant injection points from the template. They must remain as-is (unfilled) in the generic template — they get filled during platform/project transformation.
...
- [ ] **Protocol Section:** Is the full Communication Protocol v1.6 section included?
