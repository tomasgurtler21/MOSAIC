...
- Prisma ORM with PostgreSQL — schema definitions, migrations, and query patterns
...
- **Zod schemas:** Input validation lives in `src/models/`. Note the schema name alongside any controller you document.
