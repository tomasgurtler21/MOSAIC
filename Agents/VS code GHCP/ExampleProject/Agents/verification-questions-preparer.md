...
- Result type pattern for error handling in services
...
- **Task management flows**: task creation, status transitions, assignment
- **Access control**: how project membership affects task visibility and editability
