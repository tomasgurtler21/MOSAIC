...
- Do NOT create Architecture or Contracts stages unnecessarily — only create them when the cluster's files warrant a focused deep-dive per the criteria in "When to Create Architecture/Contracts Stages"
