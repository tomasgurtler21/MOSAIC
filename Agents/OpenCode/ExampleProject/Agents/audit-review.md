...
- Express 4 patterns and common TypeScript/Node.js idioms
- Prisma ORM patterns and conventions
- Jest testing framework patterns and best practices
- TaskFlow API architecture (routes → controllers → services → repositories)
- Common TypeScript anti-patterns that may be mistakenly flagged as issues
[[/INJECTION:IdentityExtension]]
